    ...
    return (
      ...
      >
        <Card className="bg-gradient-to-br from-blue-50 to-white border-blue-100">
          ...
          <CardFooter className="bg-blue-50 mt-8">
            <div className="w-full text-center">
              <p className="text-blue-600">Contact: {portfolioData.contact}</p>
              <p className="text-sm text-blue-400 mt-2">Generated by WaterWisdom.AI</p>
            </div>
          </CardFooter>
        </Card>
      </motion.div>
